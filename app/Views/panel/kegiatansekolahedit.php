    ...
    <div class="row">
        <div class="col">
            <div class="card shadow mt-4">
                ...
                <div class="card-body">
                    <form action="<?= base_url('panel/kegiatansekolahedit/' . $id) ?>" method="post">
                        <?= csrf_field(); ?>
                        <div class="form-group">
                            <label for="namakegiatan">Nama Kegiatan</label>
                            <input type="text" class="form-control" id="namakegiatan" name="namakegiatan" value="<?= $row->namakegiatan ?>" required>
                        </div>
                        <div class="form-group">
